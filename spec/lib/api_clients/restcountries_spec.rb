...
RSpec.describe ApiClients::Restcountries do
  ...
  describe "#by_code" do
    ...
    it "make request to restcountries" do
      expect(HTTParty).to receive(:get).with("https://restcountries.com/v3.1/alpha/IT").and_return(response_it)
  ...
  describe "##instance" do
    ...
    it "make request to restcountries for other country" do
      expect(HTTParty).to receive(:get).with("https://restcountries.com/v3.1/alpha/SP").and_return(response_it)
      described_class.instance.by_code("SP")

      expect(HTTParty).to receive(:get).with("https://restcountries.com/v3.1/alpha/other_country").and_return(response_it)
